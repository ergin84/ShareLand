...
class Interpretation(models.Model):
    ...
    id_functional_class = models.ForeignKey('FunctionalClass', on_delete=models.SET_NULL, null=True, blank=True, db_column='id_functional_class')
    id_typology = models.ForeignKey('Typology', on_delete=models.SET_NULL, null=True, blank=True, db_column='id_typology')
    id_typology_detail = models.ForeignKey('TypologyDetail', on_delete=models.SET_NULL, null=True, blank=True, db_column='id_typology_detail')
    notes = models.TextField(blank=True, null=True, db_column='notes')
    id_chronology = models.ForeignKey('Chronology', on_delete=models.SET_NULL, null=True, blank=True, db_column='id_chronology')
    chronology_certainty_level = models.IntegerField(default=1, blank=True, null=True, db_column='chronology_certainty_level')
...
class Investigation(models.Model):
    ...
    id_investigation_type = models.ForeignKey(InvestigationType,on_delete=models.SET_NULL, blank=True, null=True, db_column='id_investigation_type')
    id_site = models.IntegerField(blank=False, null=False, db_column='id_site')
...
class Province(models.Model):
    id = models.IntegerField(primary_key=True)
    codice_regione = models.ForeignKey(Region, to_field='id_region', db_column='codice_regione', on_delete=models.CASCADE)
...
class Research(models.Model):
    ...
    geometry = models.CharField()  # This field type is a guess.
...
class Site(models.Model):
    ...
    id_physiography = models.ForeignKey(Physiography,on_delete=models.SET_NULL, blank=True, null=True, db_column='id_physiography')
    id_base_map = models.ForeignKey(BaseMap, on_delete=models.SET_NULL, blank=True, null=True, db_column='id_base_map')
    id_positioning_mode = models.ForeignKey(PositioningMode, on_delete=models.SET_NULL,blank=True, null=True, db_column='id_positioning_mode')
    id_positional_accuracy = models.ForeignKey(PositionalAccuracy, on_delete=models.SET_NULL,blank=True, null=True, db_column='id_positional_accuracy')
    id_first_discovery_method = models.ForeignKey(FirstDiscoveryMethod, on_delete=models.SET_NULL,blank=True, null=True, db_column='id_first_discovery_method')
